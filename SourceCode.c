...
#include<stdio.h>
#include<string.h>
void VotingMessage(const char* message)
{
    int len =0;
    int pos = 0;
...
void VotingProcess(const char *message)
{
    system("cls");
    printf("\n\n\t\t\t-----------------------------------------------------------------------------");
    printf("\n\t\t\t                               Voting Machine                                 ");
...
void main()
{
    printf("\n\nWELCOME TO THE VOTE CASTING MACHINE \n\n");
    char username[15];
    char password[12];
    ...
    if(strcmp(username,"voter")==0){
        if(strcmp(password,"18")==0){
